label day_15:
    ...
    mentor smile "Likewise. I’ve heard a lot about you too. It’s great to finally put a face to the name."

    "You all chat for a bit, the atmosphere light and friendly. But suddenly, the door swings open."
    ...
    show competitor talking at center
    ...
    show competitor mock at center
